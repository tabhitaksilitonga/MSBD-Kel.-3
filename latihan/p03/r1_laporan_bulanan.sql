-- Diminta: Laporan bulanan terpadu per kategori dengan 6 metrik analitik menggunakan window function.
-- Dipilih: CTE untuk agregasi dasar bulanan per kategori, dilanjutkan window function dengan partisi berbeda (bulan vs kategori).
-- Alternatif: Subquery skalar per baris; tidak dipilih karena komputasinya sangat lambat dan redundan.
