-- Diminta: Menyiapkan skema lab5, tipe data kustom (enum dan domain), serta tabel rental_tx dan payment_tx.
-- Dipilih: DDL PostgreSQL dengan skema terisolasi lab5 agar tidak memodifikasi data pada skema public.
-- Alternatif: Menggunakan skema public langsung; tidak dipilih karena berisiko merusak tabel bawaan.
